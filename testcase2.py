...
class IxChariot_Wan2Wifi_2g_CHAN1_BW20(TestCase):
    ...
    def rx(self):
        ...
        if res2gConn is True:
            ...
            ixChariot_result_name = self.__class__.__name__ + "_RX.tst"
            throughputResult = runIxChariot(v.IXIA_STA_IP, v.IXIA_WAN_PC, ixChariot_result_name)
            setWindowsSta(self.pc, v.THROUGHPUT_SSID, 'disconn', self.__class__.__name__)
            # call tcl with ixchariot will change the redirect the path to ixchariot install path
            os.chdir(v.DEFAULT_PATH)
            # throughputResult type is str
            if throughputResult in v.TCL_RETURN:
                self.fail(msg=v.TCL_RETURN[throughputResult])
            v.THROUGHPUT_RESULT['wan2wifi_2g_1_20_rx'] = throughputResult

        else:
            self.assertTrue(res2gConn, "Connecting wifi is failed.")


class IxChariot_Wan2Wifi_2g_CHAN6_BW20(TestCase):
    @classmethod
    def setUpClass(self):
    ...
    def tx(self):
        ...
        if res2gConn is True:
            ...
            if throughputResult in v.TCL_RETURN:
                self.fail(msg=v.TCL_RETURN[throughputResult])
            v.THROUGHPUT_RESULT['wan2wifi_2g_6_20_tx'] = throughputResult
    ...
    def rx(self):
        ...
        if res2gConn is True:
            ...
            if throughputResult in v.TCL_RETURN:
                self.fail(msg=v.TCL_RETURN[throughputResult])
            v.THROUGHPUT_RESULT['wan2wifi_2g_6_20_rx'] = throughputResult

        else:
            self.assertTrue(res2gConn, "Connecting wifi is failed.")


class IxChariot_Wan2Wifi_2g_CHAN11_BW20(TestCase):
    @classmethod
    def setUpClass(self):
    ...
    def tx(self):
        ...
        if res2gConn is True:
            ...
            if throughputResult in v.TCL_RETURN:
                self.fail(msg=v.TCL_RETURN[throughputResult])
            v.THROUGHPUT_RESULT['wan2wifi_2g_11_20_tx'] = throughputResult
    ...
    def rx(self):
        ...
        if res2gConn is True:
            ...
            if throughputResult in v.TCL_RETURN:
                self.fail(msg=v.TCL_RETURN[throughputResult])
            v.THROUGHPUT_RESULT['wan2wifi_2g_11_20_rx'] = throughputResult

        else:
            self.assertTrue(res2gConn, "Connecting wifi is failed.")


class IxChariot_Wan2Wifi_2g_CHAN1_BW40(TestCase):
    @classmethod
    def setUpClass(self):
    ...
    def tx(self):
        ...
        if res2gConn is True:
            ...
            if throughputResult in v.TCL_RETURN:
                self.fail(msg=v.TCL_RETURN[throughputResult])
            v.THROUGHPUT_RESULT['wan2wifi_2g_1_40_tx'] = throughputResult
    ...
    def rx(self):
        ...
        if res2gConn is True:
            ...
            if throughputResult in v.TCL_RETURN:
                self.fail(msg=v.TCL_RETURN[throughputResult])
            v.THROUGHPUT_RESULT['wan2wifi_2g_1_40_rx'] = throughputResult

        else:
            self.assertTrue(res2gConn, "Connecting wifi is failed.")


class IxChariot_Wan2Wifi_2g_CHAN6_BW40(TestCase):
    @classmethod
    def setUpClass(self):
    ...
    def tx(self):
        ...
        if res2gConn is True:
            ...
            if throughputResult in v.TCL_RETURN:
                self.fail(msg=v.TCL_RETURN[throughputResult])
            v.THROUGHPUT_RESULT['wan2wifi_2g_6_40_tx'] = throughputResult
    ...
    def rx(self):
        ...
        if res2gConn is True:
            ...
            if throughputResult in v.TCL_RETURN:
                self.fail(msg=v.TCL_RETURN[throughputResult])
            v.THROUGHPUT_RESULT['wan2wifi_2g_6_40_rx'] = throughputResult

        else:
            self.assertTrue(res2gConn, "Connecting wifi is failed.")


class IxChariot_Wan2Wifi_2g_CHAN11_BW40(TestCase):
    @classmethod
    def setUpClass(self):
    ...
    def tx(self):
        ...
        if res2gConn is True:
            ...
            if throughputResult in v.TCL_RETURN:
                self.fail(msg=v.TCL_RETURN[throughputResult])
            v.THROUGHPUT_RESULT['wan2wifi_2g_11_40_tx'] = throughputResult
    ...
    def rx(self):
        ...
        if res2gConn is True:
            ...
            if throughputResult in v.TCL_RETURN:
                self.fail(msg=v.TCL_RETURN[throughputResult])
            v.THROUGHPUT_RESULT['wan2wifi_2g_11_40_rx'] = throughputResult

        else:
            self.assertTrue(res2gConn, "Connecting wifi is failed.")


class IxChariot_Wan2Wifi_5g_CHAN36_BW80(TestCase):
    @classmethod
    def setUpClass(self):
    ...
    def tx(self):
        ...
        res2gConn = setWindowsSta(self.pc, v.THROUGHPUT_SSID_5G, 'conn', self.__class__.__name__)
        if res2gConn is True:
            ...
            if throughputResult in v.TCL_RETURN:
                self.fail(msg=v.TCL_RETURN[throughputResult])
            v.THROUGHPUT_RESULT['wan2wifi_5g_36_80_tx'] = throughputResult
    ...
    def rx(self):
        ...
        if res2gConn is True:
            ...
            if throughputResult in v.TCL_RETURN:
                self.fail(msg=v.TCL_RETURN[throughputResult])
            v.THROUGHPUT_RESULT['wan2wifi_5g_36_80_rx'] = throughputResult

        else:
            self.assertTrue(res2gConn, "Connecting wifi is failed.")


class IxChariot_Wan2Wifi_5g_CHAN149_BW80(TestCase):
    @classmethod
    def setUpClass(self):
    ...
    def tx(self):
        ...
        if res2gConn is True:
            ...
            if throughputResult in v.TCL_RETURN:
                self.fail(msg=v.TCL_RETURN[throughputResult])
            v.THROUGHPUT_RESULT['wan2wifi_5g_149_80_tx'] = throughputResult
    ...
    def rx(self):
        ...
        if res2gConn is True:
            ...
            if throughputResult in v.TCL_RETURN:
                self.fail(msg=v.TCL_RETURN[throughputResult])
            v.THROUGHPUT_RESULT['wan2wifi_5g_149_80_rx'] = throughputResult
