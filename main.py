...
class TestSuitePage(wx.Panel):
    def __init__(self, parent):
        ...
        self.rootWirelessRelay = self.tree.AppendItem(self.root, '2.4G Wireless Relay', ct_type=1)
        self.root5gWirelessRelay = self.tree.AppendItem(self.root, '5G Wireless Relay', ct_type=1)
        ...
        self.AddTreeNodes(self.rootInternetAccessApi, data.treeInternetAccessApi)
        ...
        self.AddTreeNodes(self.root5gWirelessRelay, data.tree5gWirelessRelayApi)
